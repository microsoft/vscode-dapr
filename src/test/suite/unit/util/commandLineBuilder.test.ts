...
suite('util/commandLineBuilder', () => {
    function testBuilder(name: string, builderInitializer: (builder: CommandLineBuilder) => CommandLineBuilder, expected: string, message: string): void {
        test(name, () => {
